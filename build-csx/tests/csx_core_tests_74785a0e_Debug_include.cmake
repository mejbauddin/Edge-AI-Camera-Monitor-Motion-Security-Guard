if(EXISTS "D:/Edge AI Camera Monitor & Motion Security Guard/build-csx/tests/Debug/csx_core_tests.exe")
  discover_tests(
    COMMAND "C:/Program Files/CMake/bin/cmake.exe"
      -D [[TEST_EXECUTABLE=D:/Edge AI Camera Monitor & Motion Security Guard/build-csx/tests/Debug/csx_core_tests.exe]]
      -D [[TEST_EXECUTOR=]]
    DISCOVERY_ARGS
      -D [[TEST_FILTER=]]
